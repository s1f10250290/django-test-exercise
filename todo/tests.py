...
class TaskModelTestCase(TestCase):
    def test_create_task1(self):
        due = timezone.make_aware(datetime(2026, 6, 18, 11, 32, 15))
    ...
    def test_is_overdue_past(self):
        due = timezone.make_aware(datetime(2026, 6, 24, 23, 59, 59))
        current = timezone.make_aware(datetime(2026, 7, 1, 10, 0, 0))
...
class TodoViewTestCase(TestCase):
    ...
    def test_index_get_order_post(self):
        task1 = Task(title = 'task1', due_at = timezone.make_aware(datetime(2026, 6,18)))
        task1.save()
        task2 = Task(title='task2', due_at=timezone.make_aware(datetime(2026,7,1)))
        task2.save()
        client = Client()
